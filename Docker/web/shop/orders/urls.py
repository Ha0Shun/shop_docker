...
urlpatterns = [
    ...
    path('add_cart/<int:product_id>/<int:size_id>/<int:quantity>/', views.AddCartView.as_view(), name='add_cart'),
    ...
    path('update-cart/<int:size_id>/<int:quantity>/', views.UpdateCartView.as_view(), name='update_cart'),
